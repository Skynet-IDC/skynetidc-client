...
/***
 * This class is the entrypoint for the WHMCS Accessor The URL parameter should point to a
 * site like the following: "https://yourdomain.com/whmcs/api.php" The default constructor
 * uses the new version of the WHMCS API, which requires an Identifier and a Secret These
 * semantics are defined at the following URL:
...
public class WHMCS {
	 ...
	 * @throws IllegalArgumentException if the {@code request} argument is not a request
	 * that could have been validly built as specified by {@link HttpRequest.Builder
	 * HttpRequest.Builder}.
	 * @throws SecurityException If a security manager has been installed, and it denies
	 * {@link java.net.URLPermission access} to the URL in the given request, or proxy if
	 * one is configured. See <a href="#securitychecks">security checks</a> for further
	 * information.
	 */
