...
public class AddClientNotePayload extends Payload {
	...
	/***
	 * @param sticky Should the note be made sticky. Makes the note ‘sticky’ and displays
	 * the note throughout the client’s account and on any tickets they submit in the
	 * admin area
