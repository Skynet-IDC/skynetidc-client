...
public class UpdateClientProductPayload extends Payload {
	...
	/***
	 * @param unset An array of items to unset. Can be one of: ‘domain’,
	...
	/***
	 * @param autoRecalc Should the recurring amount of the service be automatically
	...
	/***
	 * @param configoptions Base64 encoded serialized array of configurable option field
	 * values - base64_encode(serialize(array(configoptionid => dropdownoptionid, XXX =>
	 * array(‘optionid’ => YYY, ‘qty’ => ZZZ)))) - XXX is the ID of the configurable
	 * option - YYY is the optionid found in tblhostingconfigoption.optionid - ZZZ is the
	 * quantity you want to use for that option
	 */
