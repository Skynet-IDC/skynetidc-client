...
public class CreateOAuthCredentialPayload extends Payload {
	...
	/***
	 * @param name The name to give the oAuth Credential for the authorization_code
	 * $grantType
	...
	/***
	 * @param logoURI URL or Path Relative to the Base WHMCS Client Area Directory to a
	 * logo image file for this application.
	 * @return This Payload, for chaining
	 */
