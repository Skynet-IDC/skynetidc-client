...
public class UpgradeProductPayload extends Payload {
	 ...
	 * @param paymentMethod The upgrade payment method in system format (e.g. paypal,
	 * Mailin)
	...
	/***
	 * @param configOptions An array of config options to upgrade: configoptions[id] int
	 * The id of the config option configoptions[optiontype] int The config option type
