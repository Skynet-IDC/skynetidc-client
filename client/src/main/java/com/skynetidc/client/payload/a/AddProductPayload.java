...
public class AddProductPayload extends Payload {
	...
	/***
	 * @param payType The payment type of the product. One of ‘free’, ‘onetime’,
	 * ‘recurring’
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param description The description of the product to show on the product listing in
	 * the cart
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param welcomeEmail The id of the Email Template to use as the welcome email.
	 * Product/Service Messages only
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param prorataDate See https://docs.whmcs.com/Products_and_Services#Pricing_Tab
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param prorataChargeNextMonth See
	...
	/***
	 * @param subdomain A comma separated list of subdomains to offer on the domain
	 * register page. eg: .domain1.com,.domain2.com
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param autoSetup When should the product be automatically setup. One of “ (never),
	 * ‘on’ (pending order), ‘payment’ (on payment), ‘order’ (on order)
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param module The server module system name to associate with the product. eg:
	 * cpanel, autorelease, plesk
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param serverGroupID The server group id used on product creation to associate an
	 * appropriate server
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param pricing K-V array, where K is the currency ID and V is an array of K-V
	 * values where K is the billing cycle, and V is the amount to bill.
	 * @return This Payload, for chaining
	 */
