package com.skynetidc.client.payload.t;
...
public class TriggerNotificationEventPayload extends Payload {
	...
	/***
	 * @param notification_identifier A unique identifier String, used as a condition when
	 * making a notification rule.
	 */
	...
	/***
	 * @param statusStyle A formatting style for the status of the notification, currently
	 * supports “success”, “danger”, and “info”
	 */
	...
	/***
	 * @param attributes An array of Attributes to include in the notification. Requires
	 * at least label and value parameters. Other parameters are . See
	 * WHMCS\Notification\NotificationAttribute.
	 */
