...
public class AddBillableItemPayload extends Payload {
	 ...
	 * @param description The description of the Billable Item. This will appear on the
	 * invoice
	...
	/***
	 * @param invoiceAction One of ‘noinvoice’, ‘nextcron’, ‘nextinvoice’, ‘duedate’,
	 * ‘recur’
	...
	/***
	 * @param recurCycle How often to recur the Billable Item. Days, Weeks, Months or
	 * Years.
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param dueDate Date the invoice should be due (only required for duedate & recur
	 * invoice actions). YYYY-mm-dd
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param hours Number of hours/quantity the item corresponds to. (not required for
	 * single quantities)
	 * @return This Payload, for chaining
	 */
