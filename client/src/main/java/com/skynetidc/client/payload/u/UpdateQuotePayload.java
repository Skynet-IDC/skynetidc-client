...
public class UpdateQuotePayload extends Payload {
	...
	/***
	 * @param lineItems_x__id_ For $lineitems. The id of an existing line item. Omit for
	 * new lines
	 */
	...
	/***
	 * @param lineItems_x__qty_ For $lineitems. The quantity of the line item being quoted
	 * for
	 */
	...
	/***
	 * @param lineitems_x__discount_ For $lineitems. The amount of discount to provide on
	 * the line items
	 */
