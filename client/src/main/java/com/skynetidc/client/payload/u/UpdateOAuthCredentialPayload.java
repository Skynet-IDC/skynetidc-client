...
public class UpdateOAuthCredentialPayload extends Payload {
	...
	/***
	 * @param clientApiIdentifier The OAuth API Client Credential Unique Identifier
	 * (Client ID) to be updated. Only required if credentialId is not known/passed.
	 */
	...
	/***
	 * @param grantType The grant type for which the credential set is valid for. Possible
	 * values include: authorization_code or single_sign_on
	 */
	...
	/***
	 * @param scope A space delimited list of the scopes for which the credential set is
	 * valid. See CreateOAuthCredential for permitted values
	 */
