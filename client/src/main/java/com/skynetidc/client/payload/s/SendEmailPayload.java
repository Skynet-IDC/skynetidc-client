...
public class SendEmailPayload extends Payload {
	...
	/***
	 * @param id The related id for the type of email template. Eg this should be the
	 * client id for a general type email
	 */
	...
	/***
	 * @param customType The type of custom email template to send (‘general’, ‘product’,
	 * ‘domain’, ‘invoice’, ‘support’, ‘affiliate’)
	 */
	...
	/***
	 * @param customVars The custom variables to provide to the email template. Can be
	 * used for existing and custom emails.
	 */
