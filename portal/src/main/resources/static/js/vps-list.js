let url = "assets/json/", allJobList = "", getJSON = function (t, a) {
...
function loadJobListData(t) {
    $("#job-list").DataTable({
        ...
        columns: [{data: "id"}, {data: "jobTitle"}, {data: "companyName"}, {data: "location"}, {data: "experience"}, {data: "positions"}, {
            data: "type",
            render: function (t, a, e) {
                return isType(e.type)
            }
        }, {data: "postDate"}, {data: "updateDate"}, {
            data: "status", render: function (t, a, e) {
                return isStatus(e.status)
            }
        }, {
            data: null, bSortable: !1, render: function (t, a, e) {
...
let date = new Date, today = new Date(date.getFullYear(), date.getMonth(), date.getDate());

function filterData() {
    let l = document.getElementById("idStatus").value, i = document.getElementById("idType").value,
        o = document.querySelector("#datepicker1 input").value, t = allJobList.filter(function (t) {
            let a = t.status, e = !1, s = !1, n = !1, e = "all" == a || "all" == l || a == l,
                s = "all" == t.type || "all" == i || t.type == i, n = new Date(t.postDate) <= new Date(o);
