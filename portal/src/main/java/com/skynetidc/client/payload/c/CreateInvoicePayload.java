...
public class CreateInvoicePayload extends Payload {
	 ...
	 */
	public CreateInvoicePayload(long userID) {
		super("CreateInvoice");
		put("userid", userID);
	}
	...
	/***
	 * @param draft Should the invoice be created in draft status (No need to pass $status
	 * also)
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param sendInvoice Should the Invoice Created Email be sent to the client (cannot
	 * be used with $draft)
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param taxRate The first level tax rate to apply to the invoice to override the
	 * system default
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param taxRateTwo The second level tax rate to apply to the invoice to override the
	 * system default
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param autoApplyCredit Should credit on the client account be automatically applied
	 * to the invoice
	 * @return This Payload, for chaining
	 */
