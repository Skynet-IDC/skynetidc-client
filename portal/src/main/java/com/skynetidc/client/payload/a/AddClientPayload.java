...
public class AddClientPayload extends Payload {
	 ...
	 */
	public AddClientPayload(String firstName, String lastName, String email, String address, String city, String state,
			String postCode, String country, String phoneNumber, String password) {
		super("AddClient");
