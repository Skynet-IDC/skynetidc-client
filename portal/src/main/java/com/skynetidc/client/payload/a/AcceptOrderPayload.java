...
public class AcceptOrderPayload extends Payload {
	...
	/***
	 * @param autoSetup Send the request to the product module to activate the service.
	 * This can override the product configuration.
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param sendEmail Send any automatic emails. This can be Product Welcome, Domain
