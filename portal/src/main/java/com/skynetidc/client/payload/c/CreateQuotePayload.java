...
public class CreateQuotePayload extends Payload {
	 ...
	 * @param stage The current stage of the quote (‘Draft’,‘Delivered’,‘On
	 * Hold’,‘Accepted’,‘Lost’,‘Dead’)
	 * @param validUntil The date the quote is valid until in localised format (eg
	 * DD/MM/YYYY)
	 */
	...
	/***
	 * @param dateCreated The date the quote was created in localised format (eg
	 * DD/MM/YYYY)
	 ...
	 * lineitems[x][desc] String The description of the line item lineitems[x][qty] int
	 * The quantity of the line item being quoted for lineitems[x][up] float The Unit
	 * Price of the line item lineitems[x][discount] float The amount of discount to
	 * provide on the line items lineitems[x][taxable] boolean Is the line item taxable
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param phoneNumber The phone number of the client (no country code) the quote is
	 * for if no $userid. Local format eg 4035551234
	 * @return This Payload, for chaining
	 */
