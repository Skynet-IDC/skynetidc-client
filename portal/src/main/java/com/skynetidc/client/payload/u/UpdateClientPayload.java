...
public class UpdateClientPayload extends Payload {
	...
	/***
	 * @param clientEmail The email address of the client to update. Either $clientid or
	...
	/***
	 * @param cardtype Credit card type. Provide full name: Visa, Mastercard, American
	 * Express, etc…
	 */
	...
	/***
	 * @param language Default language setting. Provide full name: ‘english’, ‘french’,
	 * etc…
	 */
