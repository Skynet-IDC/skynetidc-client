...
public class AddTicketReplyPayload extends Payload {
	...
	/***
	 * @param contactID Pass a contactid to associate the ticket reply with a specific
	 * contact belonging to $userid
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param name The name to associate with the ticket reply if not an admin or client
	 * response
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param email The email to associate with the ticket reply if not an admin or client
	 * response
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param status The status to set on the ticket after the reply is made if the
	 * default status on admin/client response is not required. See GetSupportStatuses API
	 * command
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param attachments Optional base64 json encoded array of file attachments. Can be
	 * the direct output of a multipart-form-data form submission ($_FILES superglobal in
	 * PHP) or an array of arrays consisting of both a filename and data keys
	 * @return This Payload, for chaining
	 */
