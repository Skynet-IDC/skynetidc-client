...
import com.skynetidc.client.payload.g.GetTransactionsPayload;
import org.json.JSONObject;

/***
 * This class and its methods directly relate to the API documentation. API documentation
 * can be found at the following URL: https://developers.whmcs.com/api-reference/addorder/
 */
public class AddOrderPayload extends Payload {

	/***
	 * @param clientID The client ID to add an order for
	 * @param paymentMethod The payment method for the order in the system format. eg.
	 * paypal, mailin
	 */
	public AddOrderPayload(long clientID, String paymentMethod) {
		super("AddOrder");
	 ...
	 */
	public AddOrderPayload withClientID(int clientID) {
		put("clientid", clientID);
		return this;
	}
	 ...
	 */
	public AddOrderPayload withPaymentMethod(String paymentMethod) {
		put("paymentmethod", paymentMethod);
		return this;
	}
	 ...
	 * @return This Payload, for chaining
	 */
	public AddOrderPayload withPIDs(long... pids) {
		put("pid", pids);
		return this;
	}
	...
	/***
	 * @param domainTypes For domain registrations, an array of register or transfer
	 * values
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param regPeriods For domain registrations, the registration periods for the
	 * domains in the order
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param eppCodes For domain transfers. The epp codes for the domains being
	...
	/***
	 * @param customFields An array of base64 encoded serialized array of product custom
	 * field values
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param configOptions An array of base64 encoded serialized array of product
	...
	/***
	 * @param promoOverride Should the promotion apply to the order even without matching
	...
	/***
	 * @param noInvoiceEmail Set to true to suppress the Invoice Created email being sent
	 * for the order
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param ns1Prefixes The first nameserver prefix for the VPS/Dedicated servers. Eg.
	 * ns1 in ns1.hostname.com
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param ns2Prefixes The second nameserver prefix for the VPS/Dedicated servers. Eg.
	 * ns2 in ns2.hostname.com
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param contactID The id of the contact, associated with the client, that should
	 * apply to all domains in the order
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param domainFields An array of base64 encoded serialized array of TLD Specific
	 * Field Values
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param domainPriceOverrides Override the price of the registration price on the
	...
	/***
	 * @param domainRenewOverrides Override the price of the renewal price on the domain
	 * being ordered
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param domainRenewals A name -> value array of $domainName -> $renewalPeriod
	 * renewals to add an order for
	 * @return This Payload, for chaining
	 */
	...
	/***
	 * @param serviceIDs An array of service ids to associate the addons for an Addon Only
	 * order
	 * @return This Payload, for chaining
	 */
