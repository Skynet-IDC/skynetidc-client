...
public class UpdateTransactionPayload extends Payload {
	...
	/***
	 * @param fees The amount of fee charged on the transaction by the merchant - This can
	 * be negative
	 */
	...
	/***
	 * @param credit Should the payment be applied to credit on the client account.
	 * Invoice ID must not be provided.
	 */
